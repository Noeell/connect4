...
class Connect4MainTest implements WithAssertions {
    ...
    void differentDepths() {
        var red = new Connect4ArenaMain.Connect4AlphaBetaPlayer(4);
        var blue = new Connect4ArenaMain.Connect4AlphaBetaPlayer(12);
        assertThat(newInstance().play(red, blue)).isSameAs(blue);
    }

    @Test
    void differentDepths2() {
        var red = new Connect4ArenaMain.Connect4AlphaBetaPlayer(8);
        var blue = new Connect4ArenaMain.Connect4AlphaBetaPlayer(4);
        assertThat(newInstance().play(red, blue)).isSameAs(red);
    }

    @Test
    void differentAlgos() {
        var red = new Connect4ArenaMain.Connect4MinMaxPlayer(5);
